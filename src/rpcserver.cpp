...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Ventual server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Ventual features */
        {"ventual", "vnode", &vnode, true, true, false},
        {"ventual", "listvnodes", &listvnodes, true, true, false},
        {"ventual", "getvnodecount", &getvnodecount, true, true, false},
        {"ventual", "vnodeconnect", &vnodeconnect, true, true, false},
        {"ventual", "vnodecurrent", &vnodecurrent, true, true, false},
        {"ventual", "vnodedebug", &vnodedebug, true, true, false},
        {"ventual", "startvnode", &startvnode, true, true, false},
        {"ventual", "createvnodekey", &createvnodekey, true, true, false},
        {"ventual", "getvnodeoutputs", &getvnodeoutputs, true, true, false},
        {"ventual", "listvnodeconf", &listvnodeconf, true, true, false},
        {"ventual", "getvnodestatus", &getvnodestatus, true, true, false},
        {"ventual", "getvnodewinners", &getvnodewinners, true, true, false},
        {"ventual", "getvnodescores", &getvnodescores, true, true, false},
        {"ventual", "mnbudget", &mnbudget, true, true, false},
        {"ventual", "preparebudget", &preparebudget, true, true, false},
        {"ventual", "submitbudget", &submitbudget, true, true, false},
        {"ventual", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ventual", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ventual", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ventual", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ventual", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ventual", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ventual", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ventual", "checkbudgets", &checkbudgets, true, true, false},
        {"ventual", "mnsync", &mnsync, true, true, false},
        {"ventual", "spork", &spork, true, true, false},
        {"ventual", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ventual", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ventuald, or the -server option to ventual-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ventual-cli " + methodname + " " + args + "\n";
}
