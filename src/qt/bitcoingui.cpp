                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Ventual Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Ventual address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ventual: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zVNTL"));
    ...
    QSettings settings;
    if (settings.value("fShowVnodesTab").toBool()) {
        vnodeAction = new QAction(QIcon(":/icons/vnodes"), tr("&Vnodes"), this);
        vnodeAction->setStatusTip(tr("Browse vnodes"));
        vnodeAction->setToolTip(vnodeAction->statusTip());
        vnodeAction->setCheckable(true);
#ifdef Q_OS_MAC
        vnodeAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_6));
#else
        vnodeAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_6));
#endif
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Ventual Core"), this);
    aboutAction->setStatusTip(tr("Show information about Ventual Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Ventual"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Ventual addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Ventual addresses"));
    ...
    openMNConfEditorAction = new QAction(QIcon(":/icons/edit"), tr("Open &Vnode Configuration File"), this);
    openMNConfEditorAction->setStatusTip(tr("Open Vnode configuration file"));
    ...
    openAction->setStatusTip(tr("Open a Ventual: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Ventual Core help message to get a list with possible Ventual command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Ventual Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Ventual network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count)
{
    ...
    if (vnodeSync.IsBlockchainSynced()) {
        ...
        if (vnodeSync.IsSynced()) {
            ...
            nAttempt = vnodeSync.RequestedVnodeAttempt < VNODE_SYNC_THRESHOLD ?
                           vnodeSync.RequestedVnodeAttempt + 1 :
                           VNODE_SYNC_THRESHOLD;
            progress = nAttempt + (vnodeSync.RequestedVnodeAssets - 1) * VNODE_SYNC_THRESHOLD;
            progressBar->setMaximum(4 * VNODE_SYNC_THRESHOLD);
...
{
    QString strTitle = tr("Ventual Core"); // default title
...
/** Creates context menu, its actions, and ventuals up all the relevant signals for mouse events. */
