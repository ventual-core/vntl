...
void RPCConsole::setClientModel(ClientModel* model)
{
    ...
    if (model) {
        ...
        setVnodeCount(model->getVnodeCountString());
        connect(model, SIGNAL(strVnodesChanged(QString)), this, SLOT(setVnodeCount(QString)));
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Ventual RPC console.") + "<br>" +
...
void RPCConsole::setVnodeCount(const QString& strVnodes)
{
    ui->vnodeCount->setText(strVnodes);
}
