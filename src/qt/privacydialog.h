...
public:
    ...
    void setZVentualControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzVNTL_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzVNTL_clicked();
    void on_pushButtonZVentualControl_clicked();
