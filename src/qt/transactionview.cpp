                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Vnode Reward"), TransactionFilterProxy::TYPE(TransactionRecord::MNReward));
    typeWidget->addItem(tr("Received Ventual from zVNTL"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zVNTL"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zVNTL));
