...
/**
 * Ventual RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern json_spirit::Value obfuscation(const json_spirit::Array& params, bool fHelp); // in rpcvnode.cpp
extern json_spirit::Value getpoolinfo(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value vnode(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value listvnodes(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value getvnodecount(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value vnodeconnect(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value vnodecurrent(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value vnodedebug(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value startvnode(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value createvnodekey(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value getvnodeoutputs(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value listvnodeconf(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value getvnodestatus(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value getvnodewinners(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value getvnodescores(const json_spirit::Array& params, bool fHelp);

extern json_spirit::Value mnbudget(const json_spirit::Array& params, bool fHelp); // in rpcvnode-budget.cpp
