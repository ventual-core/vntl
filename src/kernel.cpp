...
// Stake modifier consists of bits each of which is conventuald from a
...
{
    //Ventual will hash in the transaction hash and the index number in order to make sure each hash is unique
