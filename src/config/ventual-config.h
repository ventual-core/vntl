/* src/config/ventual-config.h.  Generated from ventual-config.h.in by configure.  */
/* src/config/ventual-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef VENTUAL_CONFIG_H

#define VENTUAL_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.ventual.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Ventual Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Ventual Core 1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ventual"
