...
/** 
    ...
    ****Note - for Ventual we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of ventual coming in to a transaction
