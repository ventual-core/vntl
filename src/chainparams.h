 ...
 * Ventual system. There are three: the main network on which people trade goods
...
public:
    ...
    /** The vnode count that we will allow the see-saw reward payments to be off by */
    int VnodeCountDrift() const { return nVnodeCountDrift; }
    ...
    int64_t StartVnodePayments() const { return nStartVnodePayments; }
