...
In order to support loading of multiple wallets in ventual-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ventual.cpp.
...
Changes to ventual.cpp
----------------------
ventual.cpp is the entry point into ventual-qt, and as such, will require some minor modifications to provide hooks for
