...
When restarting the client the vnodes will be stored in the datadir in
...
- Vnode caching
- Vnode payment scheduler
- Better protection from cheating vnodes
- Extended functionality for `vnode list` RPC command
