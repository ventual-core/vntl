...
- Implemented new decentralized vnode payment consensus system
- Improved speed of DS
- New vnode payment/winners/budgets syncing strategy
- Platform independent vnode ranking system
- Vnode broadcasts, pings and winners now use the inventory system
...
Thanks to who conventuald to this release, at least:
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/ventual-project/ventual-project-translations).
