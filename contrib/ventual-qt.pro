...
SOURCES += src/activevnode.cpp \
           ...
           src/main.cpp \
           src/vnode-budget.cpp \
           src/vnode-payments.cpp \
           src/vnode-sync.cpp \
           src/vnode.cpp \
           src/vnodeconfig.cpp \
           src/vnodeman.cpp \
...
RESOURCES += src/qt/ventual.qrc src/qt/ventual_locale.qrc

TRANSLATIONS += src/qt/locale/ventual_bg.ts \
                src/qt/locale/ventual_de.ts \
                src/qt/locale/ventual_en.ts \
                src/qt/locale/ventual_es.ts \
                src/qt/locale/ventual_fi.ts \
                src/qt/locale/ventual_fr.ts \
                src/qt/locale/ventual_it.ts \
                src/qt/locale/ventual_ja.ts \
                src/qt/locale/ventual_pl.ts \
                src/qt/locale/ventual_pt.ts \
                src/qt/locale/ventual_ru.ts \
                src/qt/locale/ventual_sk.ts \
                src/qt/locale/ventual_sv.ts \
                src/qt/locale/ventual_vi.ts \
                src/qt/locale/ventual_zh_CN.ts \
                src/qt/locale/ventual_zh_TW.ts
