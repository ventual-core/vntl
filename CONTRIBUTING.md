Contributing to Ventual Core
============================

The Ventual Core project operates an open contributor model where anyone is
welcome to conventual towards development in the form of peer review, testing
...
without exception conventuals patch proposals using "pull requests". This
facilitates social contribution, easy testing and peer review.

To conventual a patch, the workflow is as follows:
...
The following applies to code changes to the Ventual Core project, and is not to be
confused with overall Ventual Network Protocol consensus changes.

Whether a pull request is merged into Ventual Core rests with the project merge
...
Patches that change Ventual consensus rules are considerably more involved than
...
Where a patch set proposes to change the Ventual consensus, it must have been
...
The project leader is the release manager for each Ventual Core release.
...
the top of the file itself. Any work conventuald where you are not the original
